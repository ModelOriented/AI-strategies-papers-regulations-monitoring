...
def main(eda_for_nlp_path : str, final_table_path : str, spacy_table_path : str):
    ...
    eda.plot_counts(count_chunks, ['chunk', 'count']).write_image(file = 'plots/bar_counted_chunks_pt1.png', format = 'png')
    eda.plot_counts(count_chunks,['chunk', 'count'])

    count_chunks = eda.count_texts(noun_chunks,['chunk', 'count'], 80)[40:]
    eda.plot_counts(count_chunks, ['chunk', 'count']).write_image(file = 'plots/bar_counted_chunks_pt2.png', format = 'png')
    eda.plot_counts(count_chunks,['chunk', 'count'])

    count_chunks = eda.count_texts(noun_chunks,['chunk', 'count'], 120)[80:]
    eda.plot_counts(count_chunks, ['chunk', 'count']).write_image(file = 'plots/bar_counted_chunks_pt3.png', format = 'png')
    eda.plot_counts(count_chunks,['chunk', 'count'])
