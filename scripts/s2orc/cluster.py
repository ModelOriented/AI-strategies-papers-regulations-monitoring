...
def main(in_table_path: str, in_json_path: str, out_path: str, n_jobs:int = -1, epsilons:List[float]=[.5]):
    print("Loading data...")
    ...
    for eps in epsilons:
        ...
        print("Outliers number:", sum(df_out['cluster']==-1))
        print("Clusters number:", len(set(clusters)))
        out_path_spec, ext = os.path.spliext(out_path)
